...
This repository is used for instructional purposes in the MLIP course.

A PyTorch re-implementation of [GPT](https://github.com/openai/gpt-2), both training and inference, designed for educational use, used in CMU coursework. 

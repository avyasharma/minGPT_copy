...
This repo will teach you to code gpt from scratch in pytorch.
...
3 simple steps to `import mingpt` into your project:
This assumes you have Python 3.6+ and PyTorch already installed.
